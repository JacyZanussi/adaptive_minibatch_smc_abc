...
echo "Right now, 0-1 correspond to transcriptional dynamics, while 1-2 correspond to lotka volterra"
echo "Date: $(date)"
echo "Host: $(hostname)"
...
python -u experiment_heterogeneities.py "$SLURM_ARRAY_TASK_ID"
